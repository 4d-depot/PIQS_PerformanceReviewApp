...
$svg+="<text x=\""+String:C10($radius)+"\" y=\""+String:C10($radius)+"\" fill=\"#1267ff\" dominant-baseline=\"middle\" text-anchor=\"middle\" font-size=\""+String:C10($radius/2)+"\">"+String:C10($percent)+"%</text>"
